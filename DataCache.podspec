...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/DayItem/Datacache"
  ...
  s.source       = { :git => "https://github.com/DayItem/Datacache.git", :tag => s.version.to_s }
  ...
  s.source_files  = "DataCache/DataCache/**/*.{h,m}"
